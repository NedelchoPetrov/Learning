...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
        ...
        for(int i = years; i>0; i--){
            presentValue = presentValue + (presentValue*rateP);

        }
        //System.out.println("futureValue" + presentValue);
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double inflationPercent = 1.0 -inflationRate/100;
        double coeefizient = Math.pow(inflationPercent, targetYear - THIS_YEAR);
        double result = futureValue*coeefizient;
    ...
    static final int TARGET_YEAR = 2022;
    ...
    public static void main(String[] ignored) {
        ...
        System.out.println(futureValue(10, 12, 2020));
    }
}
